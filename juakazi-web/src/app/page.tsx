...
export default function Home() {
  return (
    <div className="flex flex-col bg-white text-zinc-950 overflow-x-hidden font-display">
      
      {/* 1. THE MASTER HERO (Elegant Refinement) */}
      <section className="relative h-[85vh] w-full mt-4 rounded-[60px] overflow-hidden group">
        <Image 
          src="/landing/juakazi hero.jpeg"
          alt="JuaKazi Master Hero"
          fill
        ...
        <div className="absolute inset-0 flex items-center justify-end px-[8%] z-20">
          ...
          >
            ...
            <h1 className="text-7xl font-black tracking-tighter text-white mb-8 leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-[#0066FF] via-[#7000FF] to-[#0066FF] bg-size-200 animate-gradient-x bg-clip-text text-transparent italic">JuaKazi.</span>
            </h1>
            ...
            <Link 
              href="/login" 
              className="group/btn h-20 px-12 bg-gradient-to-r from-[#0066FF] to-[#7000FF] text-white rounded-full font-black text-xl flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-[0_30px_60px_-15px_rgba(0,102,255,0.3)]"
            >
              Get Started <CaretRight weight="bold" size={20} className="ml-3 transition-transform group-hover/btn:translate-x-2" />
            </Link>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-zinc-50 py-32 rounded-[80px] mx-[2%] px-[5%] flex flex-col-reverse lg:flex-row items-center gap-20">
        ...
        <div className="flex-1 flex flex-col gap-8">
          ...
          <p className="text-zinc-600 text-xl leading-relaxed font-medium">
            Every JuaKazi professional carries a unique Trust Passport. 
      ...
      <section className="py-40 px-[5%] bg-white">
        <div className="flex flex-col items-center text-center gap-8 mb-24">
          ...
          <h2 className="text-[80px] font-black tracking-tighter text-zinc-950 leading-none">The JuaKazi Universe.</h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-24">
          ...
          <div className="flex-1 bg-white p-16 rounded-[72px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] border border-zinc-100">
             <div className="flex flex-col gap-10">
               <div className="h-20 w-20 rounded-[32px] bg-zinc-950 flex items-center justify-center text-white shadow-2xl">
               ...
               <button className="h-20 w-full bg-zinc-950 text-white rounded-full font-black text-sm transition-all hover:scale-[1.02] active:scale-[0.98] uppercase tracking-[0.3em] shadow-xl shadow-zinc-200">
                 Learn about Safety
               </button>
             </div>
          </div>
      ...
      <section className="py-40 px-[5%]">
        <div className="bg-zinc-950 rounded-[80px] p-24 flex flex-col items-center text-center gap-12 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0066FF]/40 to-transparent" />
          <h2 className="text-[96px] font-black tracking-tighter text-white relative z-10 leading-[0.9]">
            Ready to find your <br />
            next master pro?
          </h2>
          <div className="flex flex-col sm:flex-row gap-8 relative z-10 w-full max-w-xl">
             <Link 
              href="/join" 
              className="h-20 flex-1 flex items-center justify-center bg-white text-zinc-950 rounded-full font-black text-2xl hover:scale-105 transition-transform shadow-2xl"
            >
              Join as a Pro
            </Link>
            <Link 
              href="/explore" 
              className="h-20 flex-1 flex items-center justify-center bg-transparent border-2 border-white/20 text-white rounded-full font-black text-2xl hover:bg-white/10 transition-all"
            >
              Browse Experts
            </Link>
          </div>
      ...
      <footer className="bg-white border-t border-zinc-100 py-40 px-[5%]">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-20 mb-32">
          <div className="col-span-2 flex flex-col gap-8">
            ...
            <div className="relative h-11 w-11">
              <Image 
                src="/logo/juakazi-dark-removebg.png"
                alt="JuaKazi Logo"
                fill
        ...
        <div className="pt-16 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-8 text-[12px] font-black text-zinc-400 uppercase tracking-[0.4em]">
          <p>© 2026 JuaKazi Platform. A subsidiary of ImeanTech.</p>
