        ...
        <div className="lg:col-span-2 flex flex-col gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg leading-relaxed text-zinc-600 font-medium">
              {profile.bio || `Master ${profile.trade} specialized in high-end installations and verified craftsmanship. Committed to the JuaKazi standard of excellence and safety in every project.`}
            </p>
          </div>
