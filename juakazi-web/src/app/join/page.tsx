      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <Link href="/" className="relative h-16 w-16 bg-zinc-200/50 backdrop-blur-xl border border-white/50 rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110 mx-auto">
          <div className="relative h-11 w-11">
            <Image src="/logo/juakazi-dark-removebg.png" alt="JuaKazi Logo" fill className="object-contain brightness-0" priority />
          </div>
        </Link>
      </motion.div>
          ...
          {step === 0 && (
            <motion.div key="step0" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="flex flex-col gap-8 w-full text-center">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-zinc-500 font-bold text-sm">How do you want to use JuaKazi today?</p>
              </div>
            ...
            <motion.div key="step4" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-zinc-950/20 backdrop-blur-sm text-center">
               <div className="bg-white rounded-[40px] w-full max-w-[700px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.3)] p-12 overflow-hidden relative">
                  <div className="text-center mb-10">
                     <h2 className="text-3xl font-black tracking-tighter text-zinc-950">It&apos;s official... You&apos;re JuaKazi&apos;s newest pro!</h2>
                     <p className="text-zinc-500 font-bold text-sm mt-3 max-w-lg mx-auto leading-relaxed">Now&apos;s a great time to join Pro Plus Kickstart, our program for pros who are new to JuaKazi. Access the benefits you need to help you get your first order faster.</p>
                  </div>
