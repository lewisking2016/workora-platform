...
export function TopNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-[5%] py-5 transition-all duration-300">
      <div className="mx-auto max-w-screen-2xl p-[1.5px] rounded-full bg-gradient-to-r from-[#0066FF] to-[#7000FF] shadow-[0_12px_40px_rgba(0,102,255,0.15)] transition-all">
        <div className="flex items-center justify-between rounded-full bg-white/90 backdrop-blur-2xl px-6 py-3">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link 
              href="/login" 
              className="group relative h-10 px-6 bg-gradient-to-r from-[#0066FF] to-[#7000FF] text-white rounded-full font-black text-[11px] uppercase tracking-[0.15em] flex items-center justify-center transition-all hover:scale-105 active:scale-95 shadow-md shadow-blue-500/10"
            >
