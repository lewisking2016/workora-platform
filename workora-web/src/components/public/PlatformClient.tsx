  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900 overflow-x-clip">
      ...
      <section className="relative overflow-hidden bg-[#07090F] text-white">
        <div className="absolute -top-40 left-1/2 h-[520px] w-[820px] -translate-x-1/2 rounded-full bg-gradient-to-r from-blue-500 opacity-[0.16] blur-[120px]" />
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-10">
            <div className="max-w-xl space-y-3">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
                Experience the <span className="bg-gradient-to-r from-blue-500 bg-clip-text text-transparent">full platform</span>
              </h2>
