...
const FEED_POSTS = [
  ...
  {
    user: 'Sarah Wambui',
    title: 'Senior Electrician | Workora Verified',
    time: '1d',
  ...
  },
  {
    ...
    time: '2d',
    content: 'Looking for reliable plumbing apprentices in the Nairobi area. Must be willing to learn and grow. DM me or apply through Workora.',
    likes: 189,
    comments: 67,
    reposts: 12,
  },
...
const RECOMMENDATIONS = [
  ...
  { name: 'Grace Wanjiku', title: 'Interior Design Lead | Workora Elite', },
];
...
export default function BusinessDashboard() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      const timer = setTimeout(() => setUsername(stored), 0);
        ...
        <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between h-14">
          <div className="flex items-center gap-4">
            <Link href="/" className="relative h-9 w-9">
              <Image 
                src={isDarkMode ? "/logo/workora_logo.png" : "/logo/workora_logo.png"} 
                alt="Workora" 
                fill 
        ...
        <aside className="col-span-3 space-y-4 sticky top-20 self-start">
          ...
          <div className={`rounded-2xl border shadow-sm overflow-hidden transition-colors ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-100'}`}>
            ...
            <div className="px-5 pb-5">
              ...
              <p className="text-[10px] text-zinc-500 font-bold mt-1">Professional | Workora Verified</p>
          ...
          <div className="text-[9px] text-zinc-400 font-bold space-y-1 px-2">
            ...
            <p>&copy; 2026 KAZIORA FROM IMEANTECH</p>
          </div>
        </aside>
      </div>
    </div>
