...
const COPY: Record<CreateScreen, { title: string; description: string; primaryHref: string; primaryLabel: string; secondaryHref?: string; secondaryLabel?: string }> = {
  ...
  drafts: { title: 'Drafts screen', description: 'Open saved drafts from the live backend before publishing.', primaryHref: '/dashboard/create/new?type=post', primaryLabel: 'Open drafts' },
  'draft-detail': { title: 'Draft detail screen', description: 'Review a draft before publishing it to the live feed.', primaryHref: '/dashboard/create/new?type=post', primaryLabel: 'Open draft detail' },
